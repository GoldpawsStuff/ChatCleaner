...
Core.OnInit = function(self)
	...
	self.output.auction_sold = "|cff888888+|r |cffeaeaea"..AUCTION_SOLD_MAIL_SUBJECT.."|r"
	self.output.auction_canceled = "|cffcc4444-|r |cffeaeaea"..AUCTION_REMOVED_MAIL_SUBJECT.."|r"
	...
	self.output.currency = "|cff888888+|r |cfff0f0f0%d|r |cffeaeaea%s|r"
